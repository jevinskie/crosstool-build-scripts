...
mkdir -p build-gcc
pushd build-gcc
../${JEV_GCC}/configure --prefix=${JEV_XTOOL_PREFIX} --with-mpc=${JEV_XTOOL_PREFIX} --with-mpfr=${JEV_XTOOL_PREFIX} --with-gmp=${JEV_XTOOL_PREFIX} --with-isl=${JEV_XTOOL_PREFIX} --enable-languages=c,c++ --disable-nls --disable-multiarch --enable-sysroot --enable-plugin --target=aarch64-none-elf --without-headers --with-newlib --with-gnu-as --with-gnu-ld
...
../${JEV_GCC}/configure --prefix=${JEV_XTOOL_PREFIX} --with-mpc=${JEV_XTOOL_PREFIX} --with-mpfr=${JEV_XTOOL_PREFIX} --with-gmp=${JEV_XTOOL_PREFIX} --with-isl=${JEV_XTOOL_PREFIX} --enable-languages=c,c++ --disable-nls --disable-multiarch --enable-sysroot --enable-plugin --target=aarch64-none-elf --with-newlib --with-gnu-as --with-gnu-ld
make -j8 all
make install
popd
