...
JEV_XTOOL_PREFIX=/opt/avr/avr-xtool-2020-10-05-try1
...
# mkdir -p build-gcc
# pushd build-gcc
# ../${JEV_GCC}/configure --prefix=${JEV_XTOOL_PREFIX} --enable-languages=c,c++ --disable-nls --disable-libssp --disable-libada --enable-plugin --target=avr --with-gnu-as --with-gnu-ld
# make -j8 all-gcc
# make install-gcc
# popd
